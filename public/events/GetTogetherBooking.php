...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['action']) && $_POST['action'] === 'confirm_gettogether_booking') {
    ...
    if (empty($customer_username)) {
        ...
        if (empty($customer_username)) {
            $customer_username = !empty($contact_email) ? explode('@', $contact_email)[0] : 'gathering_host';
        }
    }
                    ...
                    <div class="step-card">
                        ...
                        <div class="review-layout">
                            <div>
                                ...
                                <?php if (!$is_logged_in): ?>
                                    <div style="background:rgba(16, 185, 129, 0.08); border:1px solid rgba(16, 185, 129, 0.2); border-radius:14px; padding:18px; margin-top:20px;">
                                        <h5 style="color:#10b981; font-weight:800; margin-bottom:6px;"><i class="fas fa-user-lock"></i> Quick Guest Booking</h5>
                                        ...
                                        <div class="form-group" style="margin-bottom:0;">
                                            ...
                                            <input type="text" class="form-input" id="guest_username" name="guest_username" placeholder="e.g. batch_2012_reunion">
                                        </div>
                                    </div>
                                <?php endif; ?>
                            </div>
